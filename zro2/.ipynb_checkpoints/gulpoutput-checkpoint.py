...
magic.write("Cl Frenkel defect energy: " + str(energies['nacl_cl_vac.out'] + energies['nacl_cl_imig.out']) + " eV" + "\n")
magic.write("Na Frenkel defect energy: " + str(energies['nacl_na_vac.out'] + energies['nacl_na_imig.out']) + " eV" + "\n")
